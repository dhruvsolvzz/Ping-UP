...
const CreatePost = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setContent('');
      setImages([]);
      return Promise.resolve(); // Needed for toast.promise success
    } catch (error) {
      return Promise.reject(); // Needed for toast.promise error
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            <button
              ...
              active:scale-95 duration-200 text-white font-medium px-8 py-3 rounded-md cursor-pointer'
            >
              Publish Post
            </button>
          </div>
